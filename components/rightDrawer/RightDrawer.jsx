...
export default function RightDrawer({ isOpen, onClose, children }) {
  return (
    <div className={`fixed z-50 top-0 right-0 w-full h-full ${isOpen ? 'visible' : 'invisible'}`}>
      ...
      <div className={`absolute z-50 pt-[20px] overflow-x-auto pb-8 top-0 right-0 h-full w-full md:w-[350px] bg-white p-4 transform ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
